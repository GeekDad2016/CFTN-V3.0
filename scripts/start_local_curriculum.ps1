...
$running=Get-CimInstance Win32_Process | Where-Object {
    $_.Name -match '^python' -and $_.CommandLine -match '-m cftn_v3\.(local_math_training|full_curriculum_training|criterion_curriculum_training|local_curriculum_pipeline)'
}
